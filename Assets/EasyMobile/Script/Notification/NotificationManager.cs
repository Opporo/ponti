...
namespace EasyMobile
{
    public class NotificationManager : MonoBehaviour
    {
        ...
        /// </summary>
        public static event System.Action<string, string, Dictionary<string, object>, bool> NotificationOpened = delegate{};
        ...
        public static void Init()
        {
            ...
            OneSignal.StartInit(EM_Settings.Notification.OneSignalAppId, EM_Settings.Notification.GoogleProjectNumber)
