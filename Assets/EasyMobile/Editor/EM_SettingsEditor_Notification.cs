...
namespace EasyMobile.Editor
{
    ...
    public partial class EM_SettingsEditor
    {
        ...
        const string OneSignalImportInstruction = "OneSignal plugin is required. Please click the button below to import it.";
        ...
        void NotificationModuleGUI()
        {
            ...
            else
            {
                ...
                EditorGUILayout.Space();
                if (GUILayout.Button("Import OneSignal Plugin", GUILayout.Height(EM_GUIStyleManager.buttonHeight)))
                {
                    EM_ExternalPluginManager.ImportOneSignalPlugin();
                }
                #else
                EditorGUILayout.Space();
                EditorGUILayout.HelpBox(OneSignalAvailMsg, MessageType.Info);
                EditorGUILayout.Space();
                if (GUILayout.Button("Reimport OneSignal Plugin", GUILayout.Height(EM_GUIStyleManager.buttonHeight)))
                {
                    EM_ExternalPluginManager.ImportOneSignalPlugin();
                }
                ...
                NotificationProperties.googleProjectNumber.property.stringValue = EditorGUILayout.TextField(NotificationProperties.googleProjectNumber.content, NotificationProperties.googleProjectNumber.property.stringValue);
