...
////// Lighting:
////// Emissive:
                float3 emissive = lerp(lerp(_Gradient1Color2.rgb,_Gradient1Color1.rgb,(i.uv0*float2(1,1)).g),lerp(_Gradient2Color1.rgb,_Gradient2Color2.rgb,(i.uv0*float2(1,1)).g),_Progression);
